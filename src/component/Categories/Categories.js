        ...
        <div class="flex flex-col  items-center hover:scale-105 transition-all font-poppins justify-center w-full max-w-sm mx-auto">
            ...
            <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                ...
                <div class="flex items-center justify-between px-3 py-2 bg-[#FF8400] dark:bg-gray-700">
                    {/* <button class="">See Items</button> */}
                    <button onClick={() => handleOneCategory(`${category.category_id}`)} className="px-2 py-1 text-xs font-semibold text-white uppercase transition-colors duration-300 transform bg-black rounded hover:bg-gray-700 dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none">See Items</button>
                </div>
            </div>
        </div>
    );
